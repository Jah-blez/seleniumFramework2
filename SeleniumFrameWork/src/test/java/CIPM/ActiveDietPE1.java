...
public class ActiveDietPE1 {
	...
	@Test
	public void testActiveDietPE1() throws Exception {
		...
		if (applybutton.size() >4) {
			applybutton.get(5).click();
		}
		else {
		...
		driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Gbamu Gbamu'])[1]/following::a[1]")).click();
