...
public class ResultUploadPE2 {
	...
	@Test
	public void testResultUploadPE2() throws Exception {
		...
		driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Open'])[12]/following::a[1]")).click();

		//input path without clicking on the dialog box
		driver.findElement(By.id("ResultFile")).clear();
		driver.findElement(By.id("ResultFile")).sendKeys("C:\\Users\\gonyebuchi\\downloads\\Result PE2.xlsx");
		driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Download Template'])[1]/following::button[1]")).click();
		driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='A'])[4]/following::button[1]")).click();
		...
		new Select(driver.findElement(By.id("ExamDietRegID"))).selectByVisibleText("baba");
		driver.findElement(By.id("ExamDietRegID")).click();
