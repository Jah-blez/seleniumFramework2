...
public class ResultUploadFoundation2 {
	...
	@Test
	public void testResultUploadFoundation2() throws Exception {
		...
		driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Open'])[5]/following::a[1]")).click();
		
		//input path without clicking on the dialog box
		driver.findElement(By.id("ResultFile")).clear();
		driver.findElement(By.id("ResultFile")).sendKeys("C:\\Users\\gonyebuchi\\downloads\\Resit.xlsx");
		driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Download Template'])[1]/following::button[1]")).click();
		driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='A'])[2]/following::button[1]")).click();
		...
		new Select(driver.findElement(By.id("ExamDietRegID"))).selectByVisibleText("Test1");
		driver.findElement(By.id("ExamDietRegID")).click();
