...
public class ResultUploadIntermediate2 {
  ...
  @Test
  public void testResultUploadIntermediate2() throws Exception {
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Open'])[9]/following::a[1]")).click();
  
    //input path without clicking on the dialog box
    driver.findElement(By.id("ResultFile")).clear();
    driver.findElement(By.id("ResultFile")).sendKeys("C:\\Users\\gonyebuchi\\downloads\\Resit result.xlsx");
    ...
    new Select(driver.findElement(By.id("ExamDietRegID"))).selectByVisibleText("Collabo");
    driver.findElement(By.id("ExamDietRegID")).click();
