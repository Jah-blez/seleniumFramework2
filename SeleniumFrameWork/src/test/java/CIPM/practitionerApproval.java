...
public class practitionerApproval {
	...
	@Test
	public static void testPractionerApproval() throws Exception {
    ...
    driver.findElement(By.xpath("//span[contains(text(),'Practitioner Application Processing')]")).click();
    ...
    Thread.sleep(2000);
    //driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='"+useremail+"'])[1]/following::button[1]")).click();
    ...
    new Select(driver.findElement(By.id("MembershipLevelID"))).selectByVisibleText("ASSOCIATE");
    driver.findElement(By.id("MembershipLevelID")).click();
