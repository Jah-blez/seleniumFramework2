...
public class ActiveDietIntermediate1 {
	...
	@Test
	public void testActiveDietIntermediate1() throws Exception {
		...
		driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Test22'])[1]/following::a[1]")).click();
