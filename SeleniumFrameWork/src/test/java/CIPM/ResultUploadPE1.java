...
public class ResultUploadPE1 {
	...
	@Test
	public void testResultUploadPE1() throws Exception {
		...
		driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Open'])[10]/following::a[1]")).click();
		
		//input path without clicking on the dialog box
		driver.findElement(By.id("ResultFile")).clear();
		driver.findElement(By.id("ResultFile")).sendKeys("C:\\Users\\gonyebuchi\\downloads\\Result PE.xlsx");
		...
		new Select(driver.findElement(By.id("ExamDietRegID"))).selectByVisibleText("Gbamu Gbamu");
		driver.findElement(By.id("ExamDietRegID")).click();
