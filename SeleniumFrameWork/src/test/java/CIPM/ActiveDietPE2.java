...
public class ActiveDietPE2 {
	...
	@Test
	public void testActiveDietPE2() throws Exception {
		...
		if (applybutton.size() >5) {
			applybutton.get(6).click();
		}
		else {
		...
		driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='baba'])[1]/following::a[1]")).click();
