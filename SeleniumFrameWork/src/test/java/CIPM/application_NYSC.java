...
public class application_NYSC {
	...
	public void testMembershipReg() throws Exception {
		...
		//Thread.sleep(3000);
		//new Select(driver.findElement(By.id("LgaID"))).selectByVisibleText("regexp:OREDO\\s+");
		...
		driver.findElement(By.id("RouteDocuments_0__UploadFile")).sendKeys(imagepath);
		Thread.sleep(2000);
		...
		application_NYSC_Approval.testApprovingApplication();
